...
Linux release runners install `fonts-liberation` and `fonts-liberation2` so public PDF artifacts use Liberation Serif instead of the wider DejaVu Serif last-resort option.
